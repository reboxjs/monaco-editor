(function () {
	...
	var METADATA = {
		CORE: {
			paths: {
				src: '/vscode/out/vs',
				'npm/dev': 'node_modules/@vscode/monaco-editor-core/dev/vs',
				'npm/min': 'node_modules/@vscode/monaco-editor-core/min/vs',
				built: '/vscode/out-@vscode/monaco-editor-core/min/vs',
