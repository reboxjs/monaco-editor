...
|------------|------------|-------------|
| [vscode](https://github.com/Microsoft/vscode) | [@vscode/monaco-editor-core](https://www.npmjs.com/package/@vscode/monaco-editor-core) | editor core functionality (language agnostic) is shipped out of vscode. |
...
* publish npm package `/src/vscode/out-@vscode/monaco-editor-core> npm publish`

#### 2. Adopt new `@vscode/monaco-editor-core` in plugins
...
* edit `/src/monaco-editor/package.json` and update the version (as necessary):
  * [npm - @vscode/monaco-editor-core](https://www.npmjs.com/package/@vscode/monaco-editor-core)
